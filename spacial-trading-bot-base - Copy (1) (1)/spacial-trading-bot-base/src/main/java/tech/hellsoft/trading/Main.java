...
public final class Main {
  ...
  public static void main(String[] args) {
    try {
      ...
      Configuration config = ConfigLoader.load("C:\\Users\\mjf71\\OneDrive\\Documentos\\GitHub\\proyecto-progra-\\spacial-trading-bot-base - Copy (1) (1)\\spacial-trading-bot-base\\src\\main\\resources\\config.json");
      printBanner();
